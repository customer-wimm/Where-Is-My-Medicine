...
const POINTS = [
  ...
  },
  {
    id: "ai",
    tag: "Intelligence",
    title: "WIMM.ai speaks your language",
    body: "Ask about drug interactions, dosage, or side effects in plain English, Hindi, or your local language. WIMM.ai gives safe, sourced answers — not generic web results.",
    stat: "24 / 7", statLabel: "WIMM.ai support",
  },
  {
    id: "speed",
    tag: "Speed",
