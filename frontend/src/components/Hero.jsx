...
export function Hero() {
  const [stats, setStats] = useState({ downloads: 10000, version: "1.0", size_mb: 34 });
    ...
    <section className="hero" id="top">
      <div className="hero__copy">
        ...
        <p className="hero__lede">
          ...
          ask WIMM.ai and consult doctors — all in one place.
        </p>
      ...
      <div className="hero__art">
        ...
        <PhoneApp route="home" interactive={false} className="phone--hero phone--float" />
        <PhoneApp route="track" interactive={false} className="phone--hero phone--behind" />
      </div>
    </section>
  );
}
